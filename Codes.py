...
API_URL          = os.getenv("API_URL", "http://145.79.10.173:8080/api/attack")
...
CHANNEL_USERNAME = os.getenv("CHANNEL_USERNAME", "BOOGLE_LOADER")
CHANNEL_INVITE   = os.getenv("CHANNEL_INVITE", "https://t.me/BOOGLE_LOADER")
...
def main():
    ...
    print("=" * 60)
    print("🌟  RIYAZ DDOS ATTACK BOT - ENHANCED VERSION")
    print("=" * 60)
